...
/* harmony import */ var _modules_picSize__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/picSize */ "./src/js/modules/picSize.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_picSize__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_9__["default"])('.accordion-heading', '.accordion-block', '.often-questions__active-style');
...
var accordion = function accordion(triggersSelector, itemsSelector, headerActive) {
...
var drop = function drop() {
  ...
  ['dragenter', 'draglive', 'dragover', 'drop'].forEach(function (eventName) {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (event) {
      ...
      var dots;
      var arrTempName = input.files[0].name.split('.');
      arrTempName[0].length > 6 ? dots = '...' : dots = '.';
      var name = arrTempName[0].substring(0, 6) + dots + arrTempName[1];
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      var dots;
      var arrTempName = item.files[0].name.split('.');
      arrTempName[0].length > 6 ? dots = '...' : dots = '.';
      var name = arrTempName[0].substring(0, 6) + dots + arrTempName[1];
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      console.log(api);
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postDate"])(api, formData).then(function (result) {
        console.log(result);
...
var modals = function modals() {
  ...
  function shnowModalByTime(selector, time) {
    setTimeout(function () {
      var display;
  ...
  openByScroll('.fixed-gift'); // shnowModalByTime('.popup-consultation', 2000);
};
...
var picSize = function picSize(selectorImg) {
...
/* harmony default export */ __webpack_exports__["default"] = (picSize);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/styles').then(function (result) {
...
/*!*************************************!*\
  !*** ./src/js/services/requests.js ***!
  \*************************************/
/*! exports provided: postDate, getResource */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
